...
public class MadLibRandom
{
	public static void main(String[] args)
	{
		...
		String adverb = adverbs[advi];	// adverb string
		...
		//changed green to a random color chosen from the array
		...
		//changed perfectly to a random adverb chosen from the array
